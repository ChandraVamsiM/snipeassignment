        ...
        <div className="container-xs flex flex-col gap-[54px] lg:px-5 md:px-5 sm:gap-[27px]">
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-row items-center">
              <Heading
                size="headingnd"
                as="h3"
                className="text-[24px] font-bold text-[#71717A] lg:text-[20px] sm:self-auto"
              >
                Register as
              </Heading>
              <RadioGroup
                name="registergroup"
                className="flex flex-row items-center px-8 sm:px-4"
              >
                <Radio
                  value="school"
                  label="School"
                  className="gap-2.5 text-[24px] text-[#71717A]"
                />
                <Radio
                  value="student"
                  label="Student"
                  className="ml-8 gap-2.5 text-[24px] text-[#71717A]"
                />
              </RadioGroup>
            </div>
          </div>
          <div className="flex items-left border border-solid  drop-shadow-lg bg-[#ffffff] md:flex-col">
            <div className="flex flex-col-2 ">
              <Img
                src="images/schoolbus1.png"
                alt="Schoolbus Image"
                className="w-[439px] h-[551px] lg:h-auto md:h-auto"
              />
              <div className="flex flex-1 flex-col items-start gap-[26px] px-8 py-6 md:self-stretch md:px-5 sm:py-4">
                <div className="flex flex-col items-start self-stretch">
                  <Heading
                    size="headingmd"
                    as="h4"
                    className="text-[24px] font-semibold text-blue_gray-900 lg:text-[20px]"
                  >
                    Name
                  </Heading>
                  <input
